...
const AdminLogin = () => {
const {loginAdmin}= useContext(UserContext) // Context for admin login
    ...
    <div className="flex justify-center items-center mt-16 mb-16">
      <div className="grid grid-cols-1 md:grid-cols-2 bg-white shadow-2xl rounded-3xl overflow-hidden max-w-4xl">
        ...
        <div className="flex justify-center items-center p-6">
          <div className="w-full max-w-md p-8 bg-amber-200 rounded-lg">
            ...
            <div className="text-center mt-6">
              <p className="text-sm text-gray-600">
                ...
                <NavLink to="/admin-signup" className="font-medium text-indigo-600 hover:text-indigo-500">
                  Sign up
                </NavLink>
              </p>
            </div>
